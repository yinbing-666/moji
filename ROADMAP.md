...
- **Phase**：v0.2.1 稳定性修复
- **状态**：第一、第二、第三阶段的 Windows 本地实现与验收完成，v0.2.0 已发布；v0.2.1 修复已提交，Windows x64 安装包已构建并通过验证，尚未推送或发布。
...
- **发布校验**：`scripts/check-release.ps1` 通过，六处版本均为 `0.2.1`；NSIS 安装包 `墨记_0.2.1_x64-setup.exe` 为 12,280,680 字节，版本元数据为 `0.2.1`，SHA-256 为 `abc0ecf633cad340f6d56f3032016dc9f2d2b91840e89816c4362a5f10dc824e`，当前未签名。
...
- **Git 状态**：v0.2.1 修复已本地提交为 `c511d15`；尚未推送、打标签或创建 GitHub Release。
